...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        mRVPoems = (RecyclerView) findViewById(R.id.RVPoems);
        final PoemAdapter adapter = new PoemAdapter();
        mRVPoems.setAdapter(adapter);
        LinearLayoutManager poemsLayoutManager =
                new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        mRVPoems.setLayoutManager(poemsLayoutManager);
